        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item">
                <a href=""><i class="la la-male"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">xxxxxxxxxxxxxxx</span>
                    <span
            ...
            <li class=" nav-item"><a href="#"><i class="la la-television"></i><span class="menu-title"
                ...
                <ul class="menu-content">
                    <li><a class="menu-item" href="#" data-i18n="nav.templates.vert.main">{{ __('dashboard.Delivery means ') }}</a>
                        <ul class="menu-content">
                            <li><a class="menu-item" href="{{ route('edit.shipping.Method','free') }}"
                                   data-i18n="nav.templates.vert.classic_menu">{{ __('dashboard.free delivery ') }}</a>
                            </li>
                            <li><a class="menu-item" href="{{ route('edit.shipping.Method','inner') }}">{{ __('dashboard.internal delivery ') }}</a>
                            </li>
                            <li><a class="menu-item" href="{{ route('edit.shipping.Method','external') }}"
                                   data-i18n="nav.templates.vert.compact_menu">{{ __('dashboard.External delivery ') }}</a>
                            </li>
                        </ul>
                    </li>
                </ul>
